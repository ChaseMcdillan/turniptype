...
// The single source of truth for the current test config.
export const state = {
  mode: "time",
  option: 30,
  language: "en",
...
export function initToolbar(onChange) {
  ...
  // --- Option chips (e.g. 5 / 10 / 15 / 30 / 60) ---
  function renderOptions() {
    ...
    // Custom mode has no preset options — show a hint instead
